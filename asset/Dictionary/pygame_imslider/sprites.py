...
class Arrow(pygame.sprite.DirtySprite):
    ...
    def __init__(self, pos_org, arrow_path, renderer, pressed_key=None):
        """
    ...
    def update(self, events, dt):
        ...
        for event in events:
            if event.type == pygame.MOUSEBUTTONDOWN\
                ...
                if self.rect.collidepoint((event.pos[0] - self.pos_org[0], event.pos[1] - self.pos_org[1])) and self.visible:
                    self.set_pressed(1)
                ...
                if self.rect.collidepoint((finger_pos[0] - self.pos_org[0], finger_pos[1] - self.pos_org[1])) and self.visible:
                    self.set_pressed(1)
...
class Dot(pygame.sprite.DirtySprite):
    ...
    def __init__(self, pos_org, dot_path, renderer):
