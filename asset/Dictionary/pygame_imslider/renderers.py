...
class ImSliderRenderer(object):
    ...
    def draw_background(self, surface):
        ...
        if self.background_color is not None and self.radius == 0:
            surface.fill(self.background_color)
        elif self.radius != 0:
            AAfilledRoundedRect(surface, (surface.get_rect()[0] + self.border_thickness, surface.get_rect()[1] + self.border_thickness, surface.get_rect()[2] - self.border_thickness * 2, surface.get_rect()[3] - self.border_thickness * 2), self.background_color, self.radius)
