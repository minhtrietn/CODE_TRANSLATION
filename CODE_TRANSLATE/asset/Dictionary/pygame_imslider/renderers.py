...
def draw_slide_state(surface, slide):
...
derRenderer is in charge of image slider rendering.
    ...
    def draw_slide(self, surface, slide):
        ...
        draw_slide_state(surface, slide)
...
ImSliderRenderer.DARK_CUSTOM = ImSliderRenderer(
    arrow_color=((255, 255, 255), (54, 54, 54)),
    dot_color=((118, 118, 118), (70, 70, 70)),
    slide_color=(68, 68, 68),
    selection_color=(35, 35, 35),
    selection_page_color=(214, 214, 214),
